...
I think the most important part of a code review is readability. When writing code on my own it is easy to think that my code is understandable. Having a fellow student or team lead look at the code and understand how it works important for understanding. The main thing I'd look for is the docstring, and if it isn't adequate there is not much chance I will be able to quickly understand what the code is doing. Using PEP8 defintely helps with the understanding of the code, making it more clear and "stylish".

Containers are helpful because they allow us to perfectly reproduce an environment without going to all the trouble and computing expense to set up virtual machines everywhere. A single image file contains all the information you need to make a container, which will be the same everywhere, regardless of the OS or other specifications of the computer it is being run on; I didn't realize this until Connor had told Mike and I about this, he also said something interesting about it being a way to basically use Linux without having to have a dual-boot system. A virtual machine would take a lot of computing power and can be time-consuming/impossible for me to set up, my system was having major issues, mostly due to the OS system in my machine. Image files can be included along with the code with minimal issue and can include any necessary prerequisites for the code. This is helpful as a codebase increases in size and complexity, with a large amount of modules that would depend on each other.
